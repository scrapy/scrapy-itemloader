...
from scrapy_itemloader import ItemLoader
from scrapy_itemloader.processors import Join, Identity, TakeFirst, \
...
class TstItem(NameItem):
    url = Field()
    summary = Field()


class TstNestedItem(Item):
    name = Field()
    name_div = Field()
    name_value = Field()
...
class NestedItemLoader(ItemLoader):
    default_item_class = TstNestedItem
...
class BasicItemLoaderTest(unittest.TestCase):
    ...
    def test_output_processor_using_function(self):
        ...
        class TakeFirstItemLoader(TstItemLoader):
            name_out = u" ".join
    ...
    def test_default_output_processor(self):
        ...
        class LalaItemLoader(TstItemLoader):
